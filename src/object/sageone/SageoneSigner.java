...
public class SageoneSigner {
	 ...
	 *            TreeMap<String, String> of key value pairs representing the
	 *            request body
	 * @param $nonce
	 *            The nonce (String)
	 * @param $secret
	 *            Your application's signing_secret (String)
	 * @param $token
	 *            Your access_token obtained during authentication (String)
	 */
	public SageoneSigner(String requestMethod, String requestUrl, TreeMap<String, String> requestBodyParams,
			String requestNonce, String signingSecret, String accessToken) {
	...
	private String baseUrl() {
		...
		final String baseUrl = parsedUrl.getProtocol() + "://" + parsedUrl.getAuthority() + parsedUrl.getPath();
		return baseUrl;
	}
	...
	private String percentEncode(final String string) {
		String encoded = null;
		try {
			encoded = URLEncoder.encode(string, "UTF-8").replaceAll("\\+", "%20");
